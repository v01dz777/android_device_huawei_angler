...
PRODUCT_COPY_FILES += \
    ...
    device/huawei/angler/media_profiles_V1_0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml

# Audio
PRODUCT_COPY_FILES += \
    device/huawei/angler/aanc_tuning_mixer.txt:$(TARGET_COPY_OUT_VENDOR)/etc/aanc_tuning_mixer.txt \
...
ifneq ($(filter aosp_angler% aosip_angler%, $(TARGET_PRODUCT)),)
PRODUCT_PROPERTY_OVERRIDES += \
